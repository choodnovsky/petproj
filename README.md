...
Цель: заменить data/lotr.txt на загрузку всех нужных тебе корпоративных документов.
----

Шаги:  
а) Соберать всю корпоративную вики:  
- Если она в виде HTML/Markdown/Confluence/Notion/Google Docs и т.п. — сначала выгрузи текст.   
- Сохрани все статьи в один или несколько .txt или .md файлов.  
б) Объединить всё в один файл data/wiki_corpus.txt или сохранить пофайлово — Chroma поддерживает оба варианта.  
